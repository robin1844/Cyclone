...
The launcher has no landmark regions. Both app headers contain a small persistent **Back** button returning directly to the launcher; in Typhoon it remains present throughout setup, countdown, workout and results screens.
